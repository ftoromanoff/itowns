    ...
    Object.defineProperty(
        ...
        category,
        {
            ...
            get: () => {
                ...
                toto[category].keys.forEach((key) => {
                    defineStyleProperty(style, category, key, value[key], toto[category].defaultValue[key]);
                });
                toto[category].ifKeys.forEach((key) => {
                    if (toto[category].defaultValue[key]) {
                        defineStyleProperty(style, category, key, value[key], toto[category].defaultValue[key]);
                    }
                });
