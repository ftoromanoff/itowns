...
class PointCloudLayer extends GeometryLayer {
    ...
    update(context, layer, elt) {
        ...
        // } else {
        //     bbox = elt.bbox.clone();
        //     // clamp the initial bbox along the z axis
        //     bbox.max.z = bbox.max.z > layer.clamp.zmax ? layer.clamp.zmax : bbox.max.z;
        //     bbox.min.z = bbox.min.z < layer.clamp.zmin ? layer.clamp.zmin : bbox.min.z;
        // }
