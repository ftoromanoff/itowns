...
var FeatureToolTip = (function _() {
    ...
    function fillToolTip(features, layer, options) {
        ...
        for (var p = 0; p < features.length; p++) {
            ...
            var styleConc = {
                fill: Object.assign({},
                    geometry.properties && geometry.properties.style && geometry.properties.style.fill ? geometry.properties.style.fill : {},
                    layer.style.fill),
                stroke: Object.assign({},
                    geometry.properties && geometry.properties.style && geometry.properties.style.stroke ? geometry.properties.style.stroke : {},
                    layer.style.stroke),
                point: Object.assign({},
                    geometry.properties && geometry.properties.style && geometry.properties.style.point ? geometry.properties.style.point : {},
                    layer.style.point),
            };
